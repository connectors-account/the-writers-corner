                      ...
                      {expandedComments.has(post.id) && (
                        ...
                        >
                          ...
                          <div className="mb-4">
                            <div className="flex gap-2">
                              <Textarea
                                ...
                                className="font-serif border-2 border-ink/30 focus:border-rust min-h-[60px] resize-none"
                                rows={2}
                              />
                              <Button
                                size="sm"
                                ...
                                disabled={!newComments[post.id]?.trim() || submittingComment.has(post.id)}
                              >
                          ...
                          {loadingComments.has(post.id) ? (
                            ...
                            <p className="text-center font-serif text-forest/70 py-2 text-sm">
