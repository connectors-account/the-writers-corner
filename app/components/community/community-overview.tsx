...
export function CommunityOverview() {
  ...
  const getAuthorName = (user: { firstName?: string; lastName?: string; name?: string }) => {
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          className={`text-forest hover:text-rust ${post.liked ? 'text-rust' : ''}`}
                        ...
                        >
                          ...
                          {loadingComments.has(post.id) ? (
                            <div className="animate-pulse space-y-2">
                              <div className="h-4 bg-sepia rounded w-3/4"></div>
                              <div className="h-4 bg-sepia rounded w-1/2"></div>
                            </div>
                          ) : (
                            <div className="space-y-3">
                              {postComments[post.id]?.length === 0 ? (
                                <p className="text-sm font-serif text-forest italic">
